...
static bool __pyx_f_16py_stringsimjoin_7sampler_6sample_comp(std::pair<int,int>  const &, std::pair<int,int>  const &); /*proto*/
...
/* "py_stringsimjoin/sampler/sample.pyx":20
 * 
 * 
 * cdef sample_pairs(vector[string]& lstrings, vector[string]& rstrings,             # <<<<<<<<<<<<<<
 *                   int sample_size, int y_param):
 *     cdef vector[vector[int]] ltokens, rtokens
 */

static PyObject *__pyx_f_16py_stringsimjoin_7sampler_6sample_sample_pairs(std::vector<std::string>  &__pyx_v_lstrings, std::vector<std::string>  &__pyx_v_rstrings, int __pyx_v_sample_size, int __pyx_v_y_param) {
 ...
 */
  __pyx_t_1 = __pyx_convert_string_from_py_std__in_string(__pyx_n_b_ws); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_tok_type = __pyx_t_1;

  /* "py_stringsimjoin/sampler/sample.pyx":26
 * 
 *     # tokenize input strings using whitespace tokenizer
 ...
 */
  __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_random); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_sample); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_FromSize_t(__pyx_v_rstrings.size()); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_5, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
 ...
 * 
 */
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_number_of_r_tuples_to_sample); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = NULL;
  __pyx_t_7 = 0;
  ...
  __pyx_t_3 = 0;
  __pyx_t_5 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_8, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  /* "py_stringsimjoin/sampler/sample.pyx":43
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "py_stringsimjoin/sampler/sample.pyx":47
 * 
 *         for j in range(tokens.size()):
 *             candidates = index.index[tokens[j]]             # <<<<<<<<<<<<<<
 *             for cand in candidates:
 ...
 */
      __pyx_t_13 = __pyx_v_candidates.begin();
      for (;;) {
        if (!(__pyx_t_13 != __pyx_v_candidates.end())) break;
        __pyx_t_14 = *__pyx_t_13;
        ++__pyx_t_13;
        __pyx_v_cand = __pyx_t_14;

        /* "py_stringsimjoin/sampler/sample.pyx":49
 *             candidates = index.index[tokens[j]]
 *             for cand in candidates:
 *                 candidate_overlap[cand] += 1             # <<<<<<<<<<<<<<
 *         for entry in candidate_overlap:
 *             tmp.push_back(entry)
 */
        __pyx_t_14 = __pyx_v_cand;
        (__pyx_v_candidate_overlap[__pyx_t_14]) = ((__pyx_v_candidate_overlap[__pyx_t_14]) + 1);
 ...
 */
    ...
    /* "py_stringsimjoin/sampler/sample.pyx":50
 *             for cand in candidates:
 *                 candidate_overlap[cand] += 1
 *         for entry in candidate_overlap:             # <<<<<<<<<<<<<<
 *             tmp.push_back(entry)
 ...
 */
    ...
    /* "py_stringsimjoin/sampler/sample.pyx":52
 *         for entry in candidate_overlap:
 *             tmp.push_back(entry)
 *         sort(tmp.begin(), tmp.end(), comp)             # <<<<<<<<<<<<<<
 *         candidate_overlap.clear()
 * 
 */
    std::sort<std::vector<std::pair<int,int> > ::iterator,bool (std::pair<int,int>  const &, std::pair<int,int>  const &)>(__pyx_v_tmp.begin(), __pyx_v_tmp.end(), __pyx_f_16py_stringsimjoin_7sampler_6sample_comp);
 ...
 */
  ...
  __Pyx_AddTraceback("py_stringsimjoin.sampler.sample.sample_pairs", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
