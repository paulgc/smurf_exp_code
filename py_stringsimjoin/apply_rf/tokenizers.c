...
/* "py_stringsimjoin/apply_rf/tokenizers.pyx":10
...
struct __pyx_vtabstruct_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer {
  std::vector<std::string>  (*tokenize)(struct __pyx_obj_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer *, std::string const &);
};
...
static std::vector<std::string>  __pyx_f_16py_stringsimjoin_8apply_rf_10tokenizers_19WhitespaceTokenizer_tokenize(struct __pyx_obj_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer *__pyx_v_self, std::string const &__pyx_v_inp_string); /* proto*/
...
/* "py_stringsimjoin/apply_rf/tokenizers.pyx":13
 *     cdef bool return_set
 * 
...
static int __pyx_pw_16py_stringsimjoin_8apply_rf_10tokenizers_19WhitespaceTokenizer_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    __pyx_v_return_set = __Pyx_PyObject_IsTrue(values[0]); if (unlikely((__pyx_v_return_set == (bool)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
...
static int __pyx_pf_16py_stringsimjoin_8apply_rf_10tokenizers_19WhitespaceTokenizer___init__(struct __pyx_obj_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer *__pyx_v_self, bool __pyx_v_return_set) {
  ...
  /* "py_stringsimjoin/apply_rf/tokenizers.pyx":14
 * 
 *     def __init__(self, bool return_set):
 *         self.return_set = return_set             # <<<<<<<<<<<<<<
 * 
...
static std::vector<std::string>  __pyx_f_16py_stringsimjoin_8apply_rf_10tokenizers_19WhitespaceTokenizer_tokenize(struct __pyx_obj_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer *__pyx_v_self, std::string const &__pyx_v_inp_string) {
  char *__pyx_v_pch;
  ...
  /* "py_stringsimjoin/apply_rf/tokenizers.pyx":18
 *     cdef vector[string] tokenize(self, const string& inp_string):
 *         cdef char* pch
 *         pch = strtok (<char*> inp_string.c_str(), " ")             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/tokenizers.pyx":21
 *         cdef oset[string] tokens
 *         cdef vector[string] out_tokens
 *         if self.return_set:             # <<<<<<<<<<<<<<
 *             while pch != NULL:
 ...
 */
  __pyx_t_1 = (__pyx_v_self->return_set != 0);
  if (__pyx_t_1) {

    /* "py_stringsimjoin/apply_rf/tokenizers.pyx":22
 *         cdef vector[string] out_tokens
 *         if self.return_set:
 *             while pch != NULL:             # <<<<<<<<<<<<<<
 *                 tokens.insert(string(pch))
 ...
 */
    while (1) {
      ...
      /* "py_stringsimjoin/apply_rf/tokenizers.pyx":23
 *         if self.return_set:
 *             while pch != NULL:
 *                 tokens.insert(string(pch))             # <<<<<<<<<<<<<<
 *                 pch = strtok (NULL, " ")
 ...
 */
      ...
      /* "py_stringsimjoin/apply_rf/tokenizers.pyx":24
 *             while pch != NULL:
 *                 tokens.insert(string(pch))
 *                 pch = strtok (NULL, " ")             # <<<<<<<<<<<<<<
 *             for s in tokens:
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/tokenizers.pyx":25
 *                 tokens.insert(string(pch))
 *                 pch = strtok (NULL, " ")
 *             for s in tokens:             # <<<<<<<<<<<<<<
 *                 out_tokens.push_back(s)
 ...
 */
    ...
    for (;;) {
      ...
      /* "py_stringsimjoin/apply_rf/tokenizers.pyx":26
 *                 pch = strtok (NULL, " ")
 *             for s in tokens:
 *                 out_tokens.push_back(s)             # <<<<<<<<<<<<<<
 *             return out_tokens
 ...
 */
    ...
    /* "py_stringsimjoin/apply_rf/tokenizers.pyx":27
 *             for s in tokens:
 *                 out_tokens.push_back(s)
 *             return out_tokens             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
  ...
  /* "py_stringsimjoin/apply_rf/tokenizers.pyx":29
 *             return out_tokens
 *         else:
 *             while pch != NULL:             # <<<<<<<<<<<<<<
 ...
 */
  /*else*/ {
    while (1) {
      ...
      /* "py_stringsimjoin/apply_rf/tokenizers.pyx":30
 *         else:
 *             while pch != NULL:
 *                 out_tokens.push_back(string(pch))             # <<<<<<<<<<<<<<
 *                 pch = strtok (NULL, " ")
 ...
 */
      ...
      try {
        __pyx_v_out_tokens.push_back(__pyx_t_2);
      } catch(...) {
        __Pyx_CppExn2PyErr();
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }

      /* "py_stringsimjoin/apply_rf/tokenizers.pyx":31
 *             while pch != NULL:
 *                 out_tokens.push_back(string(pch))
 *                 pch = strtok (NULL, " ")             # <<<<<<<<<<<<<<
 *             return out_tokens
...
/* "py_stringsimjoin/apply_rf/tokenizers.pyx":34
 *             return out_tokens
 * 
 * def test_tok(df, attr):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_16py_stringsimjoin_8apply_rf_10tokenizers_1test_tok(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_attr)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("test_tok", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "test_tok") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("test_tok", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_16py_stringsimjoin_8apply_rf_10tokenizers_test_tok(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_df, PyObject *__pyx_v_attr) {
  struct __pyx_obj_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer *__pyx_v_ws = NULL;
  std::vector<std::string>  __pyx_v_strings;
  CYTHON_UNUSED std::vector<std::string>  __pyx_v_t;
  std::string __pyx_v_s;
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer), __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_ws = ((struct __pyx_obj_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "py_stringsimjoin/apply_rf/tokenizers.pyx":37
 *     ws = WhitespaceTokenizer(True)
 *     cdef vector[string] strings
 *     convert_to_vector(df[attr], strings)             # <<<<<<<<<<<<<<
 ...
 *     for s in strings:
 */
  __pyx_t_1 = PyObject_GetItem(__pyx_v_df, __pyx_v_attr); if (unlikely(__pyx_t_1 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_f_16py_stringsimjoin_8apply_rf_10tokenizers_convert_to_vector(__pyx_t_1, __pyx_v_strings);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "py_stringsimjoin/apply_rf/tokenizers.pyx":39
 *     convert_to_vector(df[attr], strings)
 *     cdef vector[string] t
 *     for s in strings:             # <<<<<<<<<<<<<<
 *         t = ws.tokenize(s)
 * 
 */
  __pyx_t_2 = __pyx_v_strings.begin();
  for (;;) {
    if (!(__pyx_t_2 != __pyx_v_strings.end())) break;
    __pyx_t_3 = *__pyx_t_2;
    ++__pyx_t_2;
    __pyx_v_s = __pyx_t_3;
 ...
 */
    __pyx_v_t = ((struct __pyx_vtabstruct_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer *)__pyx_v_ws->__pyx_vtab)->tokenize(__pyx_v_ws, __pyx_v_s);
...
/* "py_stringsimjoin/apply_rf/tokenizers.pyx":42
 *         t = ws.tokenize(s)
 * 
 * cdef void convert_to_vector(string_col, vector[string]& string_vector):             # <<<<<<<<<<<<<<
 ...
 */
  if (likely(PyList_CheckExact(__pyx_v_string_col)) || PyTuple_CheckExact(__pyx_v_string_col)) {
    ...
    __pyx_t_2 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_v_string_col); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
 ...
 *         string_vector.push_back(val)             # <<<<<<<<<<<<<<
 */
    __pyx_t_5 = __pyx_convert_string_from_py_std__in_string(__pyx_v_val); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    try {
 ...
 *     convert_to_vector(df[attr], strings)
 */
  __pyx_tuple__2 = PyTuple_Pack(1, Py_True); if (unlikely(!__pyx_tuple__2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  __pyx_vtable_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer.tokenize = (std::vector<std::string>  (*)(struct __pyx_obj_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer *, std::string const &))__pyx_f_16py_stringsimjoin_8apply_rf_10tokenizers_19WhitespaceTokenizer_tokenize;
  if (PyType_Ready(&__pyx_type_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer.tp_dict, __pyx_vtabptr_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyObject_SetAttrString(__pyx_m, "WhitespaceTokenizer", (PyObject *)&__pyx_type_16py_stringsimjoin_8apply_rf_10tokenizers_WhitespaceTokenizer) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef vector[string] strings
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_16py_stringsimjoin_8apply_rf_10tokenizers_1test_tok, NULL, __pyx_n_s_py_stringsimjoin_apply_rf_tokeni); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_test_tok, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
