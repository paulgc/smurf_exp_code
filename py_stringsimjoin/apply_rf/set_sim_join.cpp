...
#define __PYX_HAVE__set_sim_join
#define __PYX_HAVE_API__set_sim_join
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
 ...
 */
typedef double (*__pyx_t_12set_sim_join_fnptr)(std::vector<int>  const &, std::vector<int>  const &);
...
static int (*__pyx_f_16py_stringsimjoin_8apply_rf_5utils_int_max)(int, int); /*proto*/

/* Module declarations from 'set_sim_join' */
static std::pair<std::vector<std::pair<int,int> > ,std::vector<double> >  __pyx_f_12set_sim_join_set_sim_join(std::vector<std::vector<int> >  &, std::vector<std::vector<int> >  &, int, double, int, int __pyx_skip_dispatch); /*proto*/
static void __pyx_f_12set_sim_join_set_sim_join1(std::vector<std::vector<int> >  &, std::vector<std::vector<int> >  &, int, double, int __pyx_skip_dispatch); /*proto*/
static int __pyx_f_12set_sim_join_get_prefix_length(int &, int &, double &); /*proto*/
static int __pyx_f_12set_sim_join_get_size_lower_bound(int &, int &, double &); /*proto*/
static int __pyx_f_12set_sim_join_get_size_upper_bound(int &, int &, double &); /*proto*/
static int __pyx_f_12set_sim_join_get_overlap_threshold(int &, int &, int &, double &); /*proto*/
static __pyx_t_12set_sim_join_fnptr __pyx_f_12set_sim_join_get_sim_function(int &); /*proto*/
static void __pyx_f_12set_sim_join_set_sim_join_part1(std::pair<int,int>  &, std::vector<std::vector<int> >  &, std::vector<std::vector<int> >  &, int &, double &, PositionIndex &); /*proto*/
static void __pyx_f_12set_sim_join_set_sim_join_part(std::pair<int,int> , std::vector<std::vector<int> >  &, std::vector<std::vector<int> >  &, int, double, PositionIndex &, std::vector<std::pair<int,int> >  &, std::vector<double>  &); /*proto*/
static void __pyx_f_12set_sim_join_build_index(std::vector<std::vector<int> >  &, int &, double &, PositionIndex &); /*proto*/
...
#define __Pyx_MODULE_NAME "set_sim_join"
extern int __pyx_module_is_main_set_sim_join;
int __pyx_module_is_main_set_sim_join = 0;

/* Implementation of 'set_sim_join' */
...
static const char __pyx_k_l_size[] = "l size. : ";
static const char __pyx_k_n_jobs[] = "n_jobs";
static const char __pyx_k_r_size[] = " , r size : ";
...
static const char __pyx_k_part_size[] = "part size : ";
static const char __pyx_k_threshold[] = "threshold";
static const char __pyx_k_join_started[] = "join started";
static const char __pyx_k_join_finished[] = "join finished";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_n_s_end;
static PyObject *__pyx_n_s_f2;
static PyObject *__pyx_n_s_file;
static PyObject *__pyx_kp_s_join_finished;
static PyObject *__pyx_kp_s_join_started;
...
static PyObject *__pyx_pf_12set_sim_join_set_sim_join(CYTHON_UNUSED PyObject *__pyx_self, std::vector<std::vector<int> >  __pyx_v_ltokens, std::vector<std::vector<int> >  __pyx_v_rtokens, int __pyx_v_sim_type, double __pyx_v_threshold, int __pyx_v_n_jobs); /* proto */
static PyObject *__pyx_pf_12set_sim_join_2set_sim_join1(CYTHON_UNUSED PyObject *__pyx_self, std::vector<std::vector<int> >  __pyx_v_ltokens, std::vector<std::vector<int> >  __pyx_v_rtokens, int __pyx_v_sim_type, double __pyx_v_threshold); /* proto */
/* Late includes */
...
static double __pyx_f_12set_sim_join_mytrunc(double __pyx_v_d) {
  double __pyx_r;
 ...
 */
  __pyx_r = (trunc((__pyx_v_d * 10000.0)) / 10000.0);
  goto __pyx_L0;
...
static int __pyx_f_12set_sim_join_get_prefix_length(int &__pyx_v_num_tokens, int &__pyx_v_sim_type, double &__pyx_v_threshold) {
  int __pyx_r;
  double __pyx_t_1;
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("set_sim_join.get_prefix_length", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
static int __pyx_f_12set_sim_join_get_size_lower_bound(int &__pyx_v_num_tokens, int &__pyx_v_sim_type, double &__pyx_v_threshold) {
  int __pyx_r;
  double __pyx_t_1;
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("set_sim_join.get_size_lower_bound", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
static int __pyx_f_12set_sim_join_get_size_upper_bound(int &__pyx_v_num_tokens, int &__pyx_v_sim_type, double &__pyx_v_threshold) {
  int __pyx_r;
  double __pyx_t_1;
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("set_sim_join.get_size_upper_bound", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
static int __pyx_f_12set_sim_join_get_overlap_threshold(int &__pyx_v_l_num_tokens, int &__pyx_v_r_num_tokens, int &__pyx_v_sim_type, double &__pyx_v_threshold) {
  int __pyx_r;
  double __pyx_t_1;
 ...
 */
    __pyx_r = ((int)ceil((__pyx_v_threshold * sqrt((__pyx_v_l_num_tokens * __pyx_v_r_num_tokens)))));
    goto __pyx_L0;
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("set_sim_join.get_overlap_threshold", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
static __pyx_t_12set_sim_join_fnptr __pyx_f_12set_sim_join_get_sim_function(int &__pyx_v_sim_type) {
  __pyx_t_12set_sim_join_fnptr __pyx_r;
...
static PyObject *__pyx_pw_12set_sim_join_1set_sim_join(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static std::pair<std::vector<std::pair<int,int> > ,std::vector<double> >  __pyx_f_12set_sim_join_set_sim_join(std::vector<std::vector<int> >  &__pyx_v_ltokens, std::vector<std::vector<int> >  &__pyx_v_rtokens, int __pyx_v_sim_type, double __pyx_v_threshold, int __pyx_v_n_jobs, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  __Pyx_RefNannySetupContext("set_sim_join", 0);
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_FromSize_t(__pyx_v_ltokens.size()); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_FromSize_t(__pyx_v_rtokens.size()); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyTuple_New(4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 64, __pyx_L1_error)
 ...
 */
  __pyx_f_12set_sim_join_build_index(__pyx_v_ltokens, __pyx_v_sim_type, __pyx_v_threshold, __pyx_v_index);
 ...
 */
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_partition_size); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_3 = 0;
  if (__Pyx_Print(0, __pyx_t_2, 1) < 0) __PYX_ERR(0, 75, __pyx_L1_error)
 ...
 */
    ...
    __pyx_t_8 = ((__pyx_v_i == (__pyx_v_ncpus - 1)) != 0);
    __pyx_t_7 = __pyx_t_8;
 ...
 */
    __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_start); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 81, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_end); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 81, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __pyx_t_2 = 0;
    __pyx_t_3 = 0;
    if (__Pyx_Print(0, __pyx_t_1, 1) < 0) __PYX_ERR(0, 81, __pyx_L1_error)
 ...
 */
    try {
      __pyx_t_11 = std::vector<double> ();
    } catch(...) {
      __Pyx_CppExn2PyErr();
      __PYX_ERR(0, 84, __pyx_L1_error)
    }
    try {
      __pyx_v_output_sim_scores.push_back(__pyx_t_11);
    } catch(...) {
      __Pyx_CppExn2PyErr();
      __PYX_ERR(0, 84, __pyx_L1_error)
    }
 ...
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_join_started) < 0) __PYX_ERR(0, 86, __pyx_L1_error)
 ...
 * 
 */
                            __pyx_f_12set_sim_join_set_sim_join_part((__pyx_v_partitions[__pyx_v_i]), __pyx_v_ltokens, __pyx_v_rtokens, __pyx_v_sim_type, __pyx_v_threshold, __pyx_v_index, (__pyx_v_output_pairs[__pyx_v_i]), (__pyx_v_output_sim_scores[__pyx_v_i]));
                        }
                    }
                }
            }
 ...
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_join_finished) < 0) __PYX_ERR(0, 91, __pyx_L1_error)
 ...
 */
  if (__Pyx_PrintOne(0, __pyx_n_s_f2) < 0) __PYX_ERR(0, 99, __pyx_L1_error)

  /* "set_sim_join.pyx":100
 *                              output_sim_scores[i].end())
 *     print 'f2'
 *     return output             # <<<<<<<<<<<<<<
 * #    return pair[vector[pair[int, int]], vector[double]](final_output_pairs,
 ...
 */
  ...
  __Pyx_WriteUnraisable("set_sim_join.set_sim_join", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_12set_sim_join_1set_sim_join(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_12set_sim_join_1set_sim_join(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("set_sim_join (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_ltokens,&__pyx_n_s_rtokens,&__pyx_n_s_sim_type,&__pyx_n_s_threshold,&__pyx_n_s_n_jobs,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ltokens)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rtokens)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("set_sim_join", 1, 5, 5, 1); __PYX_ERR(0, 60, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sim_type)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("set_sim_join", 1, 5, 5, 2); __PYX_ERR(0, 60, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_threshold)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("set_sim_join", 1, 5, 5, 3); __PYX_ERR(0, 60, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_jobs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("set_sim_join", 1, 5, 5, 4); __PYX_ERR(0, 60, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "set_sim_join") < 0)) __PYX_ERR(0, 60, __pyx_L3_error)
      }
    ...
    __pyx_v_ltokens = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_int_3e___(values[0]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 60, __pyx_L3_error)
    __pyx_v_rtokens = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_int_3e___(values[1]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 61, __pyx_L3_error)
    __pyx_v_sim_type = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_sim_type == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 62, __pyx_L3_error)
    __pyx_v_threshold = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_threshold == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 63, __pyx_L3_error)
    __pyx_v_n_jobs = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_n_jobs == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 63, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("set_sim_join", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 60, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("set_sim_join.set_sim_join", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_12set_sim_join_set_sim_join(__pyx_self, __pyx_v_ltokens, __pyx_v_rtokens, __pyx_v_sim_type, __pyx_v_threshold, __pyx_v_n_jobs);
...
static PyObject *__pyx_pf_12set_sim_join_set_sim_join(CYTHON_UNUSED PyObject *__pyx_self, std::vector<std::vector<int> >  __pyx_v_ltokens, std::vector<std::vector<int> >  __pyx_v_rtokens, int __pyx_v_sim_type, double __pyx_v_threshold, int __pyx_v_n_jobs) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("set_sim_join", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_convert_pair_to_py_std_3a__3a_vector_3c_std_3a__3a_pair_3c_int_2c_int_3e____3e_______std_3a__3a_vector_3c_double_3e___(__pyx_f_12set_sim_join_set_sim_join(__pyx_v_ltokens, __pyx_v_rtokens, __pyx_v_sim_type, __pyx_v_threshold, __pyx_v_n_jobs, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_12set_sim_join_3set_sim_join1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_12set_sim_join_set_sim_join1(std::vector<std::vector<int> >  &__pyx_v_ltokens, std::vector<std::vector<int> >  &__pyx_v_rtokens, int __pyx_v_sim_type, double __pyx_v_threshold, CYTHON_UNUSED int __pyx_skip_dispatch) {
  std::vector<std::vector<std::pair<int,int> > >  __pyx_v_output_pairs;
  std::vector<std::vector<double> >  __pyx_v_output_sim_scores;
  std::vector<std::pair<int,int> >  __pyx_v_partitions;
  int __pyx_v_i;
  ...
  std::vector<std::pair<int,int> >  __pyx_t_10;
  std::vector<double>  __pyx_t_11;
  __Pyx_RefNannySetupContext("set_sim_join1", 0);

  /* "set_sim_join.pyx":108
 *                                           int sim_type,
 *                                           double threshold):
 *     print 'l size. : ', ltokens.size(), ' , r size : ', rtokens.size()             # <<<<<<<<<<<<<<
 *     cdef vector[vector[pair[int, int]]] output_pairs
 *     cdef vector[vector[double]] output_sim_scores
 */
  __pyx_t_1 = __Pyx_PyInt_FromSize_t(__pyx_v_ltokens.size()); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 108, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_FromSize_t(__pyx_v_rtokens.size()); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 108, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyTuple_New(4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 108, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_INCREF(__pyx_kp_s_l_size);
  __Pyx_GIVEREF(__pyx_kp_s_l_size);
  PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_kp_s_l_size);
  ...
  __pyx_t_1 = 0;
  __pyx_t_2 = 0;
  if (__Pyx_Print(0, __pyx_t_3, 1) < 0) __PYX_ERR(0, 108, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "set_sim_join.pyx":113
 ...
 *         end = start + partition_size
 */
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_partition_size); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  PyTuple_SET_ITEM(__pyx_t_2, 1, __pyx_t_3);
  __pyx_t_3 = 0;
  if (__Pyx_Print(0, __pyx_t_2, 1) < 0) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "set_sim_join.pyx":121
 *     partition_size = <int>(<float> n / <float> ncpus)
 *     print 'part size : ', partition_size
 *     for i in range(ncpus):             # <<<<<<<<<<<<<<
 *         end = start + partition_size
 ...
 *         output_pairs.push_back(vector[pair[int, int]]())
 */
    __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_start); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 126, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_end); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 126, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __pyx_t_2 = 0;
    __pyx_t_3 = 0;
    if (__Pyx_Print(0, __pyx_t_1, 1) < 0) __PYX_ERR(0, 126, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

    /* "set_sim_join.pyx":127
 *         partitions.push_back(pair[int, int](start, end))
 *         print start, end
 *         start = end             # <<<<<<<<<<<<<<
 *         output_pairs.push_back(vector[pair[int, int]]())
 ...
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_join_started) < 0) __PYX_ERR(0, 131, __pyx_L1_error)

  /* "set_sim_join.pyx":132
 * 
 *     print 'join started'
 *     for i in prange(ncpus, nogil=True):             # <<<<<<<<<<<<<<
 *         set_sim_join_part1(partitions[i], ltokens, rtokens, sim_type, threshold,
 ...
 * 
 */
                            __pyx_f_12set_sim_join_set_sim_join_part1((__pyx_v_partitions[__pyx_v_i]), __pyx_v_ltokens, __pyx_v_rtokens, __pyx_v_sim_type, __pyx_v_threshold, __pyx_v_index);
                        }
                    }
                }
            }
 ...
 *     for i in xrange(ncpus):
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_join_finished) < 0) __PYX_ERR(0, 136, __pyx_L1_error)

  /* "set_sim_join.pyx":138
 *     print 'join finished'
 * 
 *     for i in xrange(ncpus):             # <<<<<<<<<<<<<<
 *         output.first.insert(output.first.end(),
 ...
 * 
 */
  if (__Pyx_PrintOne(0, __pyx_n_s_f2) < 0) __PYX_ERR(0, 144, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_WriteUnraisable("set_sim_join.set_sim_join1", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
...
/* Python wrapper */
static PyObject *__pyx_pw_12set_sim_join_3set_sim_join1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_12set_sim_join_3set_sim_join1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  std::vector<std::vector<int> >  __pyx_v_ltokens;
  std::vector<std::vector<int> >  __pyx_v_rtokens;
  int __pyx_v_sim_type;
  double __pyx_v_threshold;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("set_sim_join1 (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_ltokens,&__pyx_n_s_rtokens,&__pyx_n_s_sim_type,&__pyx_n_s_threshold,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rtokens)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("set_sim_join1", 1, 4, 4, 1); __PYX_ERR(0, 104, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sim_type)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("set_sim_join1", 1, 4, 4, 2); __PYX_ERR(0, 104, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_threshold)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("set_sim_join1", 1, 4, 4, 3); __PYX_ERR(0, 104, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "set_sim_join1") < 0)) __PYX_ERR(0, 104, __pyx_L3_error)
      }
    ...
    __pyx_v_ltokens = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_int_3e___(values[0]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 104, __pyx_L3_error)
    __pyx_v_rtokens = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_int_3e___(values[1]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 105, __pyx_L3_error)
    __pyx_v_sim_type = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_sim_type == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 106, __pyx_L3_error)
    __pyx_v_threshold = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_threshold == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 107, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("set_sim_join1", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 104, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("set_sim_join.set_sim_join1", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_12set_sim_join_2set_sim_join1(__pyx_self, __pyx_v_ltokens, __pyx_v_rtokens, __pyx_v_sim_type, __pyx_v_threshold);
...
static PyObject *__pyx_pf_12set_sim_join_2set_sim_join1(CYTHON_UNUSED PyObject *__pyx_self, std::vector<std::vector<int> >  __pyx_v_ltokens, std::vector<std::vector<int> >  __pyx_v_rtokens, int __pyx_v_sim_type, double __pyx_v_threshold) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("set_sim_join1", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_12set_sim_join_set_sim_join1(__pyx_v_ltokens, __pyx_v_rtokens, __pyx_v_sim_type, __pyx_v_threshold, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 104, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static void __pyx_f_12set_sim_join_set_sim_join_part1(std::pair<int,int>  &__pyx_v_partition, CYTHON_UNUSED std::vector<std::vector<int> >  &__pyx_v_ltokens, std::vector<std::vector<int> >  &__pyx_v_rtokens, int &__pyx_v_sim_type, double &__pyx_v_threshold, PositionIndex &__pyx_v_index) {
 ...
 */
    __pyx_v_prefix_length = __pyx_f_12set_sim_join_get_prefix_length(__pyx_v_m, __pyx_v_sim_type, __pyx_v_threshold);

    /* "set_sim_join.pyx":167
 *         m = tokens.size()
 *         prefix_length = get_prefix_length(m, sim_type, threshold)
 *         size_lower_bound = get_size_lower_bound(m, sim_type, threshold)             # <<<<<<<<<<<<<<
 *         size_upper_bound = get_size_upper_bound(m, sim_type, threshold)
 * #        print i, 'p1'
 */
    __pyx_v_size_lower_bound = __pyx_f_12set_sim_join_get_size_lower_bound(__pyx_v_m, __pyx_v_sim_type, __pyx_v_threshold);

    /* "set_sim_join.pyx":168
 *         prefix_length = get_prefix_length(m, sim_type, threshold)
 *         size_lower_bound = get_size_lower_bound(m, sim_type, threshold)
 *         size_upper_bound = get_size_upper_bound(m, sim_type, threshold)             # <<<<<<<<<<<<<<
 * #        print i, 'p1'
 ...
 */
    __pyx_v_size_upper_bound = __pyx_f_12set_sim_join_get_size_upper_bound(__pyx_v_m, __pyx_v_sim_type, __pyx_v_threshold);

    /* "set_sim_join.pyx":170
 *         size_upper_bound = get_size_upper_bound(m, sim_type, threshold)
 * #        print i, 'p1'
 *         for size in range(size_lower_bound, size_upper_bound + 1):             # <<<<<<<<<<<<<<
 ...
 * #        print i, 'p2'
 */
    __pyx_t_4 = (__pyx_v_size_upper_bound + 1);
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = __pyx_v_size_lower_bound; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_size = __pyx_t_6;

      /* "set_sim_join.pyx":171
 * #        print i, 'p1'
 *         for size in range(size_lower_bound, size_upper_bound + 1):
 *             overlap_threshold_cache[size] = get_overlap_threshold(size, m, sim_type, threshold)             # <<<<<<<<<<<<<<
 * #        print i, 'p2'
 * 
 */
      (__pyx_v_overlap_threshold_cache[__pyx_v_size]) = __pyx_f_12set_sim_join_get_overlap_threshold(__pyx_v_size, __pyx_v_m, __pyx_v_sim_type, __pyx_v_threshold);
    }

    /* "set_sim_join.pyx":174
 * #        print i, 'p2'
 * 
 ...
 * 
 */
      __pyx_t_9 = ((__pyx_v_index.index.find((__pyx_v_tokens[__pyx_v_j])) == __pyx_v_index.index.end()) != 0);
      if (__pyx_t_9) {

        /* "set_sim_join.pyx":176
 *         for j in range(prefix_length):
 *             if index.index.find(tokens[j]) == index.index.end():
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_13 = __pyx_v_candidate_overlap.begin();
    for (;;) {
      if (!(__pyx_t_13 != __pyx_v_candidate_overlap.end())) break;
      __pyx_t_14 = *__pyx_t_13;
      ++__pyx_t_13;
      __pyx_v_entry = __pyx_t_14;

      /* "set_sim_join.pyx":206
 * #        print i, candidate_overlap.size()
 *         for entry in candidate_overlap:
 *             if entry.second > 0:             # <<<<<<<<<<<<<<
 * #                sim_score = sim_fn(ltokens[entry.first], tokens)
...
static void __pyx_f_12set_sim_join_set_sim_join_part(std::pair<int,int>  __pyx_v_partition, std::vector<std::vector<int> >  &__pyx_v_ltokens, std::vector<std::vector<int> >  &__pyx_v_rtokens, int __pyx_v_sim_type, double __pyx_v_threshold, PositionIndex &__pyx_v_index, std::vector<std::pair<int,int> >  &__pyx_v_output_pairs, std::vector<double>  &__pyx_v_output_sim_scores) {
  std::map<int,int>  __pyx_v_candidate_overlap;
  std::map<int,int>  __pyx_v_overlap_threshold_cache;
  std::vector<std::pair<int,int> >  __pyx_v_candidates;
  std::vector<int>  __pyx_v_tokens;
  ...
  __pyx_t_12set_sim_join_fnptr __pyx_v_sim_fn;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
  long __pyx_t_4;
 ...
 *     for i in range(partition.first, partition.second):
 */
  __pyx_v_sim_fn = __pyx_f_12set_sim_join_get_sim_function(__pyx_v_sim_type);

  /* "set_sim_join.pyx":234
 *     sim_fn = get_sim_function(sim_type)
 * 
 *     for i in range(partition.first, partition.second):             # <<<<<<<<<<<<<<
 *         tokens = rtokens[i]
 ...
 */
    __pyx_v_size_lower_bound = __pyx_f_16py_stringsimjoin_8apply_rf_5utils_int_max(__pyx_f_12set_sim_join_get_size_lower_bound(__pyx_v_m, __pyx_v_sim_type, __pyx_v_threshold), __pyx_v_index.min_len);

    /* "set_sim_join.pyx":240
 *         size_lower_bound = int_max(get_size_lower_bound(m, sim_type, threshold),
 *                                    index.min_len)
 *         size_upper_bound = int_min(get_size_upper_bound(m, sim_type, threshold),             # <<<<<<<<<<<<<<
 *                                    index.max_len)
 * #        print i, 'p1'
 */
    __pyx_v_size_upper_bound = __pyx_f_16py_stringsimjoin_8apply_rf_5utils_int_min(__pyx_f_12set_sim_join_get_size_upper_bound(__pyx_v_m, __pyx_v_sim_type, __pyx_v_threshold), __pyx_v_index.max_len);

    /* "set_sim_join.pyx":243
 *                                    index.max_len)
 * #        print i, 'p1'
 *         for size in range(size_lower_bound, size_upper_bound + 1):             # <<<<<<<<<<<<<<
 *             overlap_threshold_cache[size] = get_overlap_threshold(size, m, sim_type, threshold)
 ...
 *                     output_sim_scores.push_back(sim_score)
 */
        __pyx_t_12 = ((__pyx_v_sim_score > __pyx_v_threshold) != 0);
        if (__pyx_t_12) {

          /* "set_sim_join.pyx":278
 *                 #print ltokens[entry.first], rtokens[i], entry.second, sim_score
 *                 if sim_score > threshold:
 *                     output_pairs.push_back(pair[int, int](entry.first, i))             # <<<<<<<<<<<<<<
 *                     output_sim_scores.push_back(sim_score)
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("set_sim_join.set_sim_join_part", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* "set_sim_join.pyx":284
 *         overlap_threshold_cache.clear()
 * 
 * cdef void build_index(vector[vector[int]]& token_vectors, int& sim_type, double& threshold, PositionIndex &pos_index):             # <<<<<<<<<<<<<<
...
static void __pyx_f_12set_sim_join_build_index(std::vector<std::vector<int> >  &__pyx_v_token_vectors, int &__pyx_v_sim_type, double &__pyx_v_threshold, PositionIndex &__pyx_v_pos_index) {
  std::vector<int>  __pyx_v_tokens;
 ...
 */
      try {
        __pyx_t_7 = std::pair<int,int> (__pyx_v_i, __pyx_v_j);
      } catch(...) {
        __Pyx_CppExn2PyErr();
        __PYX_ERR(0, 294, __pyx_L1_error)
      }
      try {
        (__pyx_v_index[(__pyx_v_tokens[__pyx_v_j])]).push_back(__pyx_t_7);
      } catch(...) {
        __Pyx_CppExn2PyErr();
        __PYX_ERR(0, 294, __pyx_L1_error)
      }
 ...
 *         if m < min_len:
 */
    __pyx_t_8 = ((__pyx_v_m > __pyx_v_max_len) != 0);
    if (__pyx_t_8) {

      /* "set_sim_join.pyx":296
 *             index[tokens[j]].push_back(pair[int, int](i, j))
 *         if m > max_len:
 *             max_len = m             # <<<<<<<<<<<<<<
 *         if m < min_len:
 ...
 */
    __pyx_t_8 = ((__pyx_v_m < __pyx_v_min_len) != 0);
    if (__pyx_t_8) {

      /* "set_sim_join.pyx":298
 *             max_len = m
 *         if m < min_len:
 *             min_len = m             # <<<<<<<<<<<<<<
 *     pos_index.set_fields(index, size_vector, min_len, max_len, threshold)
 ...
 */
  __pyx_v_pos_index.set_fields(__pyx_v_index, __pyx_v_size_vector, __pyx_v_min_len, __pyx_v_max_len, __pyx_v_threshold);
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("set_sim_join.build_index", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_convert_vector_to_py_std_3a__3a_pair_3c_int_2c_int_3e___(__pyx_v_p.first); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 159, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
...
static PyMethodDef __pyx_methods[] = {
  {"set_sim_join", (PyCFunction)__pyx_pw_12set_sim_join_1set_sim_join, METH_VARARGS|METH_KEYWORDS, 0},
  {"set_sim_join1", (PyCFunction)__pyx_pw_12set_sim_join_3set_sim_join1, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_set_sim_join(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_set_sim_join},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_join_finished, __pyx_k_join_finished, sizeof(__pyx_k_join_finished), 0, 0, 1, 0},
  {&__pyx_kp_s_join_started, __pyx_k_join_started, sizeof(__pyx_k_join_started), 0, 0, 1, 0},
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("set_sim_join", (void (*)(void))__pyx_f_12set_sim_join_set_sim_join, "std::pair<std::vector<std::pair<int,int> > ,std::vector<double> >  (std::vector<std::vector<int> >  &, std::vector<std::vector<int> >  &, int, double, int, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ExportFunction("set_sim_join1", (void (*)(void))__pyx_f_12set_sim_join_set_sim_join1, "void (std::vector<std::vector<int> >  &, std::vector<std::vector<int> >  &, int, double, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __pyx_t_1 = __Pyx_ImportModule("py_stringsimjoin.apply_rf.sim_functions"); if (!__pyx_t_1) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "jaccard", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_13sim_functions_jaccard, "double (std::vector<int>  const &, std::vector<int>  const &)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "dice", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_13sim_functions_dice, "double (std::vector<int>  const &, std::vector<int>  const &)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "cosine", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_13sim_functions_cosine, "double (std::vector<int>  const &, std::vector<int>  const &)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  Py_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_2 = __Pyx_ImportModule("py_stringsimjoin.apply_rf.utils"); if (!__pyx_t_2) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_2, "int_min", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_5utils_int_min, "int (int, int)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_2, "int_max", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_5utils_int_max, "int (int, int)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initset_sim_join(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initset_sim_join(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_set_sim_join(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_set_sim_join(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_set_sim_join(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_set_sim_join(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("set_sim_join", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_set_sim_join) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "set_sim_join")) {
      if (unlikely(PyDict_SetItemString(modules, "set_sim_join", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init set_sim_join", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init set_sim_join");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
