...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++", 
        "name": "edit_distance_join", 
        "sources": [
            "edit_distance_join.pyx", 
            "inverted_index.cpp"
        ]
    }, 
    "module_name": "edit_distance_join"
}
END: Cython Metadata */
...
#define __PYX_HAVE__edit_distance_join
#define __PYX_HAVE_API__edit_distance_join
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
/* Module declarations from 'edit_distance_join' */
static std::pair<std::vector<std::pair<int,int> > ,std::vector<double> >  __pyx_f_18edit_distance_join_ed_join(std::vector<std::vector<int> >  &, std::vector<std::vector<int> >  &, int, double, std::vector<std::string>  &, std::vector<std::string>  &, int, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE int __pyx_f_18edit_distance_join_int_min(int, int); /*proto*/
static void __pyx_f_18edit_distance_join_ed_join_part(std::pair<int,int> , std::vector<std::vector<int> >  &, std::vector<std::vector<int> >  &, int, double, InvertedIndex &, std::vector<std::string>  &, std::vector<std::string>  &, std::vector<std::pair<int,int> >  &, std::vector<double>  &); /*proto*/
...
#define __Pyx_MODULE_NAME "edit_distance_join"
extern int __pyx_module_is_main_edit_distance_join;
int __pyx_module_is_main_edit_distance_join = 0;

/* Implementation of 'edit_distance_join' */
...
static PyObject *__pyx_pf_18edit_distance_join_ed_join(CYTHON_UNUSED PyObject *__pyx_self, std::vector<std::vector<int> >  __pyx_v_ltokens, std::vector<std::vector<int> >  __pyx_v_rtokens, int __pyx_v_qval, double __pyx_v_threshold, std::vector<std::string>  __pyx_v_lstrings, std::vector<std::string>  __pyx_v_rstrings, int __pyx_v_n_jobs); /* proto */
/* Late includes */

/* "edit_distance_join.pyx":15
...
static PyObject *__pyx_pw_18edit_distance_join_1ed_join(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static std::pair<std::vector<std::pair<int,int> > ,std::vector<double> >  __pyx_f_18edit_distance_join_ed_join(std::vector<std::vector<int> >  &__pyx_v_ltokens, std::vector<std::vector<int> >  &__pyx_v_rtokens, int __pyx_v_qval, double __pyx_v_threshold, std::vector<std::string>  &__pyx_v_lstrings, std::vector<std::string>  &__pyx_v_rstrings, int __pyx_v_n_jobs, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_FromSize_t(__pyx_v_ltokens.size()); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_FromSize_t(__pyx_v_rtokens.size()); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyTuple_New(4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 22, __pyx_L1_error)
  ...
  __pyx_t_1 = 0;
  __pyx_t_2 = 0;
  if (__Pyx_Print(0, __pyx_t_3, 1) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "edit_distance_join.pyx":26
 *     cdef vector[vector[double]] output_sim_scores
 ...
 */
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_partition_size); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_3 = 0;
  if (__Pyx_Print(0, __pyx_t_2, 1) < 0) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "edit_distance_join.pyx":32
 *     partition_size = <int>(<float> n / <float> ncpus)
 *     print 'part size : ', partition_size
 *     for i in range(ncpus):             # <<<<<<<<<<<<<<
 *         end = start + partition_size
 ...
 */
    __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_start); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_end); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __pyx_t_2 = 0;
    __pyx_t_3 = 0;
    if (__Pyx_Print(0, __pyx_t_1, 1) < 0) __PYX_ERR(0, 37, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

    /* "edit_distance_join.pyx":38
 *         partitions.push_back(pair[int, int](start, end))
 *         print start, end
 *         start = end             # <<<<<<<<<<<<<<
 *         output_pairs.push_back(vector[pair[int, int]]())
 ...
 * 
 */
                            __pyx_f_18edit_distance_join_ed_join_part((__pyx_v_partitions[__pyx_v_i]), __pyx_v_ltokens, __pyx_v_rtokens, __pyx_v_qval, __pyx_v_threshold, __pyx_v_index, __pyx_v_lstrings, __pyx_v_rstrings, (__pyx_v_output_pairs[__pyx_v_i]), (__pyx_v_output_sim_scores[__pyx_v_i]));
                        }
                    }
                }
            }
 ...
 */
  ...
  __Pyx_WriteUnraisable("edit_distance_join.ed_join", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
...
/* Python wrapper */
static PyObject *__pyx_pw_18edit_distance_join_1ed_join(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_18edit_distance_join_1ed_join(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("ed_join (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_ltokens,&__pyx_n_s_rtokens,&__pyx_n_s_qval,&__pyx_n_s_threshold,&__pyx_n_s_lstrings,&__pyx_n_s_rstrings,&__pyx_n_s_n_jobs,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rtokens)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("ed_join", 1, 7, 7, 1); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_qval)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ed_join", 1, 7, 7, 2); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_threshold)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ed_join", 1, 7, 7, 3); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lstrings)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ed_join", 1, 7, 7, 4); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rstrings)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ed_join", 1, 7, 7, 5); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_jobs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ed_join", 1, 7, 7, 6); __PYX_ERR(0, 15, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "ed_join") < 0)) __PYX_ERR(0, 15, __pyx_L3_error)
      }
    ...
    __pyx_v_ltokens = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_int_3e___(values[0]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_rtokens = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_int_3e___(values[1]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L3_error)
    __pyx_v_qval = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_qval == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L3_error)
    __pyx_v_threshold = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_threshold == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_lstrings = __pyx_convert_vector_from_py_std_3a__3a_string(values[4]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_rstrings = __pyx_convert_vector_from_py_std_3a__3a_string(values[5]); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_n_jobs = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_n_jobs == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("ed_join", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 15, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("edit_distance_join.ed_join", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_18edit_distance_join_ed_join(__pyx_self, __pyx_v_ltokens, __pyx_v_rtokens, __pyx_v_qval, __pyx_v_threshold, __pyx_v_lstrings, __pyx_v_rstrings, __pyx_v_n_jobs);
...
static CYTHON_INLINE int __pyx_f_18edit_distance_join_int_min(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  int __pyx_t_1;
...
static void __pyx_f_18edit_distance_join_ed_join_part(std::pair<int,int>  __pyx_v_partition, CYTHON_UNUSED std::vector<std::vector<int> >  &__pyx_v_ltokens, std::vector<std::vector<int> >  &__pyx_v_rtokens, int __pyx_v_qval, double __pyx_v_threshold, InvertedIndex &__pyx_v_index, std::vector<std::string>  &__pyx_v_lstrings, std::vector<std::string>  &__pyx_v_rstrings, std::vector<std::pair<int,int> >  &__pyx_v_output_pairs, std::vector<double>  &__pyx_v_output_sim_scores) {
  ...
  int __pyx_t_10;
  std::set<int> ::iterator __pyx_t_11;
  int __pyx_t_12;
  std::pair<int,int>  __pyx_t_13;

  /* "edit_distance_join.pyx":69
 ...
 */
    __pyx_v_prefix_length = __pyx_f_18edit_distance_join_int_min(((int)((__pyx_v_qval * __pyx_v_threshold) + 1.0)), __pyx_v_m);

    /* "edit_distance_join.pyx":77
 *         prefix_length = int_min(<int>(qval * threshold + 1), m)
 * 
 *         for j in range(prefix_length):             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_7 = ((__pyx_v_index.index.find((__pyx_v_tokens[__pyx_v_j])) == __pyx_v_index.index.end()) != 0);
      if (__pyx_t_7) {

        /* "edit_distance_join.pyx":79
 *         for j in range(prefix_length):
 *             if index.index.find(tokens[j]) == index.index.end():
 *                 continue             # <<<<<<<<<<<<<<
 *             for cand in index.index[tokens[j]]:
 ...
 * 
 */
      __pyx_t_9 = &(__pyx_v_index.index[(__pyx_v_tokens[__pyx_v_j])]);
      __pyx_t_8 = __pyx_t_9->begin();
      for (;;) {
        if (!(__pyx_t_8 != __pyx_t_9->end())) break;
        __pyx_t_10 = *__pyx_t_8;
        ++__pyx_t_8;
        __pyx_v_cand = __pyx_t_10;

        /* "edit_distance_join.pyx":81
 *                 continue
 *             for cand in index.index[tokens[j]]:
 *                 candidates.insert(cand)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (;;) {
      ...
      ++__pyx_t_11;
      __pyx_v_cand = __pyx_t_4;

      /* "edit_distance_join.pyx":85
 * ##        print i, candidate_overlap.size()
 *         for cand in candidates:
 *             if m - threshold <= index.size_vector[cand] <= m + threshold:             # <<<<<<<<<<<<<<
 *                 edit_dist = edit_distance(lstrings[cand], rstrings[i])
 ...
 */
      __pyx_t_4 = (__pyx_v_index.size_vector[__pyx_v_cand]);
      __pyx_t_7 = ((__pyx_v_m - __pyx_v_threshold) <= __pyx_t_4);
      if (__pyx_t_7) {
        __pyx_t_7 = (__pyx_t_4 <= (__pyx_v_m + __pyx_v_threshold));
      }
      __pyx_t_12 = (__pyx_t_7 != 0);
      if (__pyx_t_12) {

        /* "edit_distance_join.pyx":86
 *         for cand in candidates:
 *             if m - threshold <= index.size_vector[cand] <= m + threshold:
 *                 edit_dist = edit_distance(lstrings[cand], rstrings[i])             # <<<<<<<<<<<<<<
 *                 if edit_dist <= threshold:
 ...
 */
        __pyx_t_12 = ((__pyx_v_edit_dist <= __pyx_v_threshold) != 0);
        if (__pyx_t_12) {

          /* "edit_distance_join.pyx":88
 *                 edit_dist = edit_distance(lstrings[cand], rstrings[i])
 *                 if edit_dist <= threshold:
 *                     output_pairs.push_back(pair[int, int](cand, i))             # <<<<<<<<<<<<<<
 *                     output_sim_scores.push_back(edit_dist)
 ...
 */
          try {
            __pyx_t_13 = std::pair<int,int> (__pyx_v_cand, __pyx_v_i);
          } catch(...) {
            #ifdef WITH_THREAD
            PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
            #endif
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("edit_distance_join.ed_join_part", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}
...
static PyMethodDef __pyx_methods[] = {
  {"ed_join", (PyCFunction)__pyx_pw_18edit_distance_join_1ed_join, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_edit_distance_join(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_edit_distance_join},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("ed_join", (void (*)(void))__pyx_f_18edit_distance_join_ed_join, "std::pair<std::vector<std::pair<int,int> > ,std::vector<double> >  (std::vector<std::vector<int> >  &, std::vector<std::vector<int> >  &, int, double, std::vector<std::string>  &, std::vector<std::string>  &, int, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "edit_distance", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_13sim_functions_edit_distance, "double (std::string const &, std::string const &)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  Py_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_2 = __Pyx_ImportModule("py_stringsimjoin.apply_rf.utils"); if (!__pyx_t_2) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_2, "build_prefix_index", (void (**)(void))&__pyx_f_16py_stringsimjoin_8apply_rf_5utils_build_prefix_index, "void (std::vector<std::vector<int> >  &, int, double, InvertedIndex &)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initedit_distance_join(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initedit_distance_join(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_edit_distance_join(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_edit_distance_join(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_edit_distance_join(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_edit_distance_join(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("edit_distance_join", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_edit_distance_join) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "edit_distance_join")) {
      if (unlikely(PyDict_SetItemString(modules, "edit_distance_join", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init edit_distance_join", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init edit_distance_join");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
